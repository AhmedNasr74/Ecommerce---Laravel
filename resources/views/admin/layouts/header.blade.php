...
<html>
    ...
    @else
    <link rel="stylesheet" href="{{admin_design('')}}/dist/css/rtl/AdminLTE.min.css">
    <link rel="stylesheet" href="{{admin_design('')}}/dist/css/rtl/bootstrap-rtl.min.css">
    <link rel="stylesheet" href="{{admin_design('')}}/dist/css/rtl/rtl.css">
