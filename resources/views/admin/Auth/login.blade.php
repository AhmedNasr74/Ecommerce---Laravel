...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{admin_routes('login')}}" method="post">
        @csrf
      <div class="form-group  has-{{session()->has('login_error') ? 'error' :'feedback' }}">
        <input type="email" name="email" class="form-control" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-{{session()->has('login_error') ? 'error' :'feedback' }}">
        <input type="password" id="inputError1" name="password" class="form-control" placeholder="Password">
    ...
    <a href="{{admin_routes('password/forgot')}}">I forgot my password</a><br>
