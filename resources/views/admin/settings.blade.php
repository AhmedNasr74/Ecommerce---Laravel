...
<div class="box">
  ...
  <!-- /.box-header -->
  <div class="box-body">
    {!! Form::open(['url'=>admin_routes('settings'),'files'=>true]) !!}
    ...
    <div class="form-group">
      ...
      {!! Form::file('logo',['class'=>'form-control']) !!}
        @if (!empty(setting()->logo))
            <img src="{{Storage::url(setting()->logo)}}" alt="logo" class="img-responsive img-box">
        @endif
    </div>
    ...
    <div class="form-group" style="display:block">
      ...
      {!! Form::file('icon',['class'=>'form-control']) !!}
        @if (!empty(setting()->icon))
            <img src="{{Storage::url(setting()->icon)}}" alt="icon" class="img-responsive img-box">
        @endif
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      {!! Form::select('main_lang',['ar'=>trans('admin.ar'),'en'=>trans('admin.en')],setting()->main_lang,['class'=>'form-control','style'=>'padding:5px']) !!}
    </div>
     <div class="form-group">
    ...
    {!! Form::submit(trans('admin.save'),['class'=>'btn btn-block btn-success']) !!}
    {!! Form::close() !!}
  </div>
  <!-- /.box-body -->
</div>
