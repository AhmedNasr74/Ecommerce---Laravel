...
<head>
  ...
  <title>{{trans('admin.changePassword')}}</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" id="inputError1" name="password" class="form-control" placeholder="New Password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
            <input type="password" id="inputError1" name="password_confirmation" class="form-control" placeholder="Confirmation Password">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
      <div class="row">
        <div class="col-xs-12">
