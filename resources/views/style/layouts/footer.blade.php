...
<!-- jQuery sticky menu -->
<script src="{{ustore_design()}}/js/owl.carousel.min.js"></script>
<script src="{{ustore_design()}}/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="{{ustore_design()}}/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{ustore_design()}}/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{ustore_design()}}/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{ustore_design()}}/js/script.slider.js"></script>
</body>
